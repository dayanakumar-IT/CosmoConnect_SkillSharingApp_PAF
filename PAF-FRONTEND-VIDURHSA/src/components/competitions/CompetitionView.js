...
import { FaClock, FaCalendarAlt, FaTrophy, FaUsers, FaArrowLeft } from 'react-icons/fa';
import img1 from '../../assets/images/img1.jpg';
import img2 from '../../assets/images/img2.jpg';

const CompetitionView = ({ competition, isAdmin = false }) => {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="h-64 bg-gradient-to-r from-purple-600 to-blue-600 rounded-t-lg relative overflow-hidden">
          <img
            src={getCompetitionImage(competition.category)}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-300">{competition.category}</span>
